      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <div className="px-8 md:px-14 pb-20 pt-12 flex flex-col justify-start gap-2 animate-in fade-in slide-in-from-left-6 duration-1000">
          <div className="flex flex-col">
            ...
            <Heading
              size="lg"
              className="text-5xl md:text-7xl mb-4 tracking-tighter drop-shadow-2xl leading-none"
            >
              Reborn
            </Heading>
            ...
            <div className="flex items-center flex-wrap gap-4">
              <div className="flex items-center gap-2 bg-white/5 backdrop-blur-md w-fit px-3 py-1.5 rounded-xl border border-white/5 shadow-2xl">
                ...
                <Text
                  size="md"
                  className="font-bold text-white/90 text-[11px] tracking-wide"
                >
                  Felippe Donatto <span className="text-white/20 mx-2">|</span>{' '}
                  <span className="text-white/40 font-bold italic uppercase text-[8px] tracking-widest">
                    Single
                  </span>
                </Text>
              </div>
              ...
              <div className="flex items-center gap-1">
                <Link href="/albuns/reborn">
                  <button
                    type="button"
                    className="px-5 py-2.5 bg-primary text-black font-black text-[9px] uppercase tracking-[0.2em] rounded-lg hover:scale-105 hover:bg-white transition-all shadow-xl shadow-primary/20 cursor-pointer active:scale-95"
                  >
                    Ouvir Agora
                  </button>
                </Link>
